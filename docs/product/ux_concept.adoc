...
* einfache Handlungsempfehlungen, Kennzahlen, Analysen
...
| *Verhalten & Kontext*
a|
* Befasst sich mit Finanzen nur Samstag abend am PC / Laptop
nutzt die digitalen Produkte die er zwingend benötigt, aber ist nicht stolz darauf
* Achtet sehr darauf welche Daten er von sich preisgibt
* ist äußerst skeptisch gegenüber aller Art von digitalen Finanzen, sieht aber ein, dass er nicht drumherum kommt
* Schätzt vertrauenswürdige, transparente Dienstleister sehr

| *Bezug zum Produkt*
| Kein Bankzugang, Gastmodus verfügbar +
  Es muss datenschutzkonform nutzbar.
|===
