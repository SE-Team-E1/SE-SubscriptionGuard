...
| Farbpalette
| Primarfarbe: #2c3e50; Sekundärfarbe: #ebebeba2; Begründung: Hoher Kontrast, simple Farbgebung.

| Typografie
| Text: Inter 16px; Begründung: Hohe Lesbarkeit auf kleinen Bildschirmen,  keine verspielten bzw. schnörkeligen Schriftarten, die ablenken.

| Ikonografie
| Material Design Icons; konsistentes Icon-Set im gesamten Produkt

| Bildsprache
| Illustrationen: Flat Design, minimalistisch, keine realistischen Fotos; Begründung: Reduziert Ablenkung, unterstützt schnelle Informationsaufnahme.
|===
